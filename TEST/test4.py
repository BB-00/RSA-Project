...
origin_coordinates = (40.87298802142687, -73.91837748140901)
destination_coordinates = (40.704915658685785, -74.01411032751835)
...
origin_node = ox.nearest_nodes(G, X=origin_coordinates[0], Y=origin_coordinates[1])
print(origin_node)
destination_node = ox.nearest_nodes(G, X=destination_coordinates[0], Y=destination_coordinates[1])
